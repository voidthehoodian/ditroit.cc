...
game.StarterGui:SetCore("SendNotification", {Title = "Detroit.cc", Text = "Detroit.cc = ON", Duration = 5,}) -- initially on.

local function ItsOn()
	game.StarterGui:SetCore("SendNotification", {Title = "Detroit.cc", Text = "Drtroit.cc = ON", Duration = 5,})
end
local function ItsOff()
	game.StarterGui:SetCore("SendNotification", {Title = "Detroit.cc", Text = "Detroit.cc = OFF", Duration = 5,})
end
